...
int main()
{
	...
	char program[12] = { 0x48, 0xc7, 0xc0, 0x3c, 0, 0, 0, 0x48, 0x31, 0xff, 0x0f, 0x05 };

	char text[11] = { 'H', 'e', 'l', 'l', 'o', ' ', 'w', 'o', 'r', 'l', 'd' };

	elf.write(hello_world, sizeof hello_world);
	elf.write(program, sizeof program);
	elf.write(text, sizeof text);

	//48c7c001000000 48c7c701000000 48c7c03c000000 4831ff 0f05
