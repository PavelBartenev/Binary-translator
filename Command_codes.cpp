...
char mov_qword_r8_num[3] = { 0x49, 0xc7, 0x00 };

char mov_rdi_qword_r8[3] = { 0x49, 0x8b, 0x38 };
...
char lea_r8_rsp_minus_200[8] = { 0x4c, 0x8d, 0x84, 0x24, 0x38, 0xff, 0xff, 0xff };
...
char inc_r8[3] = { 0x49, 0xff, 0xc0 };

char dec_rsi[3] = { 0x48, 0xff, 0xce };
char dec_r8[3] = { 0x49, 0xff, 0xc8 };
